...
pub static FT_LOAD_NO_SCALE: u32 = (0x1 << 1) as u32;
pub static FT_LOAD_NO_HINTING: u32 = (0x1 << 2) as u32;
pub static FT_LOAD_RENDER: u32 = (0x1 << 3) as u32;
pub static FT_LOAD_NO_BITMAP: u32 = (0x1 << 4) as u32;
pub static FT_LOAD_VERTICAL_LAYOUT: u32 = (0x1 << 5) as u32;
pub static FT_LOAD_FORCE_AUTOHINT: u32 = (0x1 << 6) as u32;
pub static FT_LOAD_CROP_BITMAP: u32 = (0x1 << 7) as u32;
pub static FT_LOAD_PENDANTIC: u32 = (0x1 << 8) as u32;
